      ...
      <section className="main-section about-section" id="about">
        ...
        <div className="about-p-img">
          <p className="p-about">Hi, my name is Emanuel and i love traveling, trekking and sports. <br/> My interest in web development started a few years ago.
            ...
            I like to continue learning new technologies and tools to be able to solve problems and exchange ideas with the team because it&apos;s essential in this changing and evolitionary world.</p>
          <img className="img-about" src="../../../public/foto perfil.jpg" />
        </div>
      </section>    
